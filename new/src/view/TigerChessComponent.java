...
public class TigerChessComponent extends ChessComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(owner.getColor().equals(Color.RED)) {
            Image elephantBlueImage = Toolkit.getDefaultToolkit().getImage("resource\\tiger-red.png");
            g2.drawImage(elephantBlueImage, 0, 0, getWidth(), getHeight(), null);
        }else{
            Image elephantRedImage = Toolkit.getDefaultToolkit().getImage("resource\\tiger-blue.png");
