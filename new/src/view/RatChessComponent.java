...
public class RatChessComponent extends ChessComponent {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(owner.getColor().equals(Color.RED)) {
            Image elephantBlueImage = Toolkit.getDefaultToolkit().getImage("resource\\mouse-red.png");
            g2.drawImage(elephantBlueImage, 0, 0, getWidth(), getHeight(), null);
        }else{
            Image elephantRedImage = Toolkit.getDefaultToolkit().getImage("resource\\mouse-blue.png");
